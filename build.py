...
def compile_js(manifest,config):
    js_file = os.path.join(cwd,'assets','net.hoyohoyo.tiremotecontrol.js')
...
""" % module_assets
    ...
    assets_router = os.path.join(cwd,'Classes','NetHoyohoyoTiremotecontrolModuleAssets.m')
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','net.hoyohoyo.tiremotecontrol.js']
